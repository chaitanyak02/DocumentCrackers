...
namespace Infosys.DC.WelldataInitializer
{
    static class SearchResources
    {
        public static DataSource GetDataSource(string name) =>
            DataSource.AzureBlobStorage(
                name: name,
                storageConnectionString: ConfigurationManager.AppSettings["BlobStorageAccountConnectionString"],
        ...
        public static Skillset GetSkillset(string name, string azureFunctionHostKey, string blobContainerNameForImageStore)
        {
            ...
            {
                Name = name,
                Description = "WellData Files Skillset",
        ...
        public static Index GetIndex(string name, string synonymMapName) => new Index()
        {
            ...
            Fields = new List<Field>()
            {
                ...
                new Field("well_name",       DataType.Collection(DataType.String)) { IsSearchable = true, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = true },
                new Field("well_number",     DataType.Collection(DataType.String)) { IsSearchable = true, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = true},
                new Field("lease_number",    DataType.Collection(DataType.String)) { IsSearchable = true, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = true },
                new Field("region",          DataType.Collection(DataType.String)) { IsSearchable = true, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = true},
                new Field("file_path",       DataType.String)                      { IsSearchable = true, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = false },
                new Field("file_type",       DataType.String)                      { IsSearchable = true, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = false },
                new Field("file_size",       DataType.String)                      { IsSearchable = false, IsFilterable = false, IsRetrievable = true, IsSortable = false, IsFacetable = false },
                new Field("field",           DataType.String) { IsSearchable = true, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = false },
                new Field("lease",           DataType.Collection(DataType.String)) { IsSearchable = true, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = true },
                new Field("well",            DataType.String) { IsSearchable = true, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = false },
                new Field("authorby",        DataType.String) { IsSearchable = true, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = false },
                new Field("reportDate",       DataType.String) { IsSearchable = true, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = false },
                new Field("topDepthValue",    DataType.Int32) { IsSearchable = false, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = false },
                new Field("boreDepthValue",   DataType.Int32) { IsSearchable = false, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = false },
                new Field("bottomDepthValue", DataType.Int32) { IsSearchable = false, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = false },
                new Field("APIWell",          DataType.String) { IsSearchable = true, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = false },
                new Field("Area",             DataType.String) { IsSearchable = true, IsFilterable = true, IsRetrievable = true, IsSortable = false, IsFacetable = false }
