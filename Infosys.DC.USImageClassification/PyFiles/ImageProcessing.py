...
def ImageProcess(path,DiskPath):
   try:
        ...
        if("Splits" in path):
                ...
                files = ['C:\\Projects\\Converge\\249_sp_noise.PNG', 'C:\\Projects\\Converge\\249_Smoothened_image.PNG', 'C:\\Projects\\Converge\\249_Enhanced_image.PNG']
                for f in files:
                    shutil.copy(f, 'C:\Projects\Converge\IP_outputs')
...
if __name__=='__main__':
    StartImageProcessing(r'C:\\Projects\\Data Mining RFS\\249\\sp_noise.jpg')
